...
import useWeaponSpecializationSelect from './hooks';

const Component = () => {
  const {props, actions} = useWeaponSpecializationSelect();

  return (
    <Screen testID="WeaponSpecializationSelectScreen">
      <Preview
        height="360px"
        imageHeight="560px"
        testID="Preview"
